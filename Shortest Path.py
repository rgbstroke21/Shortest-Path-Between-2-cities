    ...
    try:
        ...
        if flag == 2:
            ...
            if city1 == city2:
                ...
                try:
                    while not edge_weight.isdigit():
                        if str(edge_weight) == '0' or edge_weight[0] == "-":
                    ...
                    while len(edge_weight) == 0:
                        messagebox.showinfo("Information",
                                            "Please Enter The distance between city {} and city {} in km".format(city1,
                                                                                                                 city2))
                        edge_weight = askstring('Input',
                                                'Enter The distance between city {} and city {} in km : '.format(city1,
                                                                                                                 city2))
